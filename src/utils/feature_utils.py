...
# --- Project Utilities ---
from src.constants import PROJECT_ROOT, TRAIN_PATH, VAL_PATH
...
def load_train_val_data() -> tuple[pd.DataFrame, pd.DataFrame]:
    ...
    try:
        ...
        logger.info(f"Data loaded: Train shape {train_df.shape}, Val shape {val_df.shape}")
        return train_df, val_df
    except FileNotFoundError as e:
        logger.error(f"Data file not found. Ensure 'make_dataset.py' has been executed. Error: {e}")
        raise
