...
from src.entity.config_entity import FeatureComparisonConfig
...
def main() -> None:
    ...
    # --- MLflow Setup ---
    setup_experiment("Exp - Feature Comparison (TFIDF vs DistilBERT)", config.mlflow_uri)
    ...
    if config.use_distilbert:
        ...
        logger.info("[INFO] DistilBERT experiment intentionally skipped (use_distilbert=False).")
