"""
Automated Endpoint Test for Sentiment Inference API
===================================================

This test script validates that the FastAPI server (src.models.predict_model)
...
In a new terminal, run the test client:
    uv run python -m src.models.app.test_inference
